...
if(COMPILER_SUPPORTS_CXX17)
    ...
    message(FATAL_ERROR "The compiler ${CMAKE_CXX_COMPILER} has no C++17 support, or our tests failed to detect it correctly. Please use a different C++ compiler or report this problem to the developers.")
endif()
...
if(OpenCV_FOUND)
	...
	set(HAVE_OPENCV_XFEATURES2D_NONFREE true)
	...
	set(HAVE_OPENCV_CUDAFEATURES2D false)
