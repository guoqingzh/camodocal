...
extrinsic_calib -c $1/data/${selected_dataset}/${selected_data}/camodocal_input_caminfo --camera-count ${num_camera} --camera-index ${cam_index} -m 30 --input $1/data/${selected_dataset}/${selected_data}/camodocal_input_data/ --keydist 0.1 --begin-stage 0 -v 
